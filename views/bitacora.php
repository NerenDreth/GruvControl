...
<head>
    ...
    <title>GruvControl | Bitácora del Sistema</title>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .header-title h2 { color: #fbf1c7; font-size: 1.35rem; margin-bottom: 0.25rem; }
        body.light .header-title h2 { color: #3c3836; }
        .header-title small { color: #928374; font-size: 0.75rem; }
        body.light .header-title small { color: #7c6f64; }
        ...
        .badge { display: inline-block; padding: 0.2rem 0.6rem; border-radius: 20px; font-size: 0.65rem; font-weight: 600; background: #458588; color: #fbf1c7; }
        body.light .badge { background: #458588; color: #fbf1c7; }
        .table-responsive { overflow-x: auto; }
        .d-flex { display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 1rem; }
    </style>
</head>
<body>
<div class="container">
        ...
        <div class="card-header">
            <div class="d-flex" style="width: 100%;">
                <div class="header-title">
                    ...
                    <small>Registro de acciones realizadas por los usuarios</small>
                </div>
                <div>
            ...
            <div class="table-responsive">
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><?= $b['id'] ?></td>
                            <td><span class="badge"><?= htmlspecialchars($b['usuario']) ?></span></td>
