...
<head>
    ...
    <title>GruvControl | Editar Usuario</title>
...
<div class="container">
    <div class="card">
        ...
        <div class="card-body">
            <form action="index.php?view=actualizarUsuario" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="password" class="form-control" value="<?= htmlspecialchars($usuario['password']) ?>" required>
                </div>
                <div class="mb-3">
